...
void HTMLBuilder::buildTitle(const std::string& title) {                 // HTML文件的标题
...
void HTMLBuilder::buildString(const std::string& str) {                  // HTML文件中的字符串
    writer << "<p>" << str << "</p>" << '\n';                                   // 用<p>标签输出
}

void HTMLBuilder::buildItems(const std::vector<std::string>& items) {    // HTML文件中的条目
    writer << "<ul>" << '\n';                                                   // 用<ul>和<li>输出
...
void HTMLBuilder::buildDone() {                                             // 完成文档
    writer << "</body></html>" << '\n';                                         // 关闭标签
    writer.close();                                                             // 关闭文件
}
